   ...
   render() {
      return (
         <div className="About section">
            <h1 className="about-intro">My Story</h1>
            <p className="about-item">I grew up in the <a href="https://en.wikipedia.org/wiki/Dubuque,_Iowa" target="_blank" rel="noopener noreferrer">midwest</a> and moved to Denver, Colorado in 2007, which was in my <a href="https://en.wikipedia.org/wiki/Saturn_return" target="_blank" rel="noopener noreferrer">saturn return</a>, to seek out a change in my life.  I wasn't quite sure what direction to go.  In late 2013, I eventually took some free online coding classes in my down time on HTML, CSS, and JavaScript.  I discovered that I could spend all day learning to code and before I knew it, the day would be almost over and I wasn't ready to stop.  That was the moment I decided to find out how to make this my next career.  But I couldn't afford to quit work for going back to school full time.  The timing wasn't right yet.</p>
            ...
            <p className="about-item">Before I could jump into this head first, I had to be sure I could do this.  In early 2017, I attended a Try Coding weekend which covered the front and back end at a local coding school and my mind was blown on how much more there is to learn.  Being myself, I had to be absolutely sure this was the right direction for me before commiting to the big change.  The same coding school offered a 6-week evening class, Second Shift Front End Foundations.  After completion, I was certain I wanted to do this.</p>
            ...
            <p className="about-item">When I'm not at my day job or practicing code, I'm usually at home relaxing with my wife.  We love our downtime.  I enjoy going to punk and rock shows, traveling, doing yard work, staying up late, and sleeping in.  I was really into skating, biking, and snowboarding but have since had to slow down.  I played hockey since I was nine years old and had to take off a couple of years due to life.  I look forward to getting back to stopping pucks again once I have more free time.</p>  
